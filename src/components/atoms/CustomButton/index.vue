...
<style lang="scss">
  .custom-button {
    ...
    &.brown {
      ...
      &:hover {
        color: $white;
        background-color: $peanutCocoa;
      }
    }
  }

  .custom-button.yellow.--invert {
    color: $white;
    background-color: $coconutLemon;
